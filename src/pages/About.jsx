    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <p className="text-gray-600 leading-relaxed text-lg mb-6">
          Kalawati Marriage Lawn has been the premier wedding venue in Gorakhpur for over 15 years. Our sprawling lawns, grand banquet halls, and dedicated staff ensure every event is a masterpiece of celebration.
        </p>
